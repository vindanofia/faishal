...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<script>
			...
			var updatePelChart2 = function(e) {
				var period = $(e).val().replace(' ', '_')
				$.get('List_pelanggaran/get_chart_data_mitra/' + period, function(result) {
					if (pelChart2) {
						pelChart2.destroy()
						$('.ket-area2').empty()
					}
					...
					var colors = [];
					$.each(result.ket2, function(index, value) {
						$('.ket-area2').append('<h5>(' + result.labels[index] + ') ' + value + '</h5>')
						colors.push('rgb(115, 194, 251)')
					})
