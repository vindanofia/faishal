				...
				foreach ($row->result() as $key => $data) { ?>
					<tr>
						...
						<td class="text-center" width="160px">
							<a href="<?= site_url('Admin/list_pelanggaran/edit/' . $data->id_list_pel) ?>" class="btn btn-primary btn-xs">
								<i class="fa fa-pencil"></i> Ubah
							</a>
							<a href="<?= site_url('Admin/list_pelanggaran/del/' . $data->id_list_pel) ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger btn-xs">
