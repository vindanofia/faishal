		...
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				<p class="alert alert-info">Anda dapat download Format Excel 
					<a href="<?= site_url('Admin/pegawai/downloadFormat'); ?>"><strong>Disini</strong></a>
				</p>
				<form action="<?= site_url('Admin/pegawai/processImport'); ?>" method="post" enctype="multipart/form-data">
