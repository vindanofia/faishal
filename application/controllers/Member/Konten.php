...
class Konten extends CI_Controller
{
	...
	function get_ajax()
	{
		...
		foreach ($list as $konten) {
			...
			$row[] = $konten->foto;
			$row[] = '<a href="' . site_url('Member/konten/edit/' . $konten->id_konten) . '" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Update</a>
			<a href="' . site_url('Member/konten/del/' . $konten->id_konten) . '" onclick="return confirm(\'Yakin hapus data?\')"  class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a>';
			$data[] = $row;
		}
		$output = array(
			"draw" => @$_POST['draw'],
